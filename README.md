...
```sh
kubectl apply -f https://raw.githubusercontent.com/dynatrace-oss/koney/refs/tags/v0.2.1/dist/install.yaml
...
```sh
kubectl delete -f https://raw.githubusercontent.com/dynatrace-oss/koney/refs/tags/v0.2.1/dist/install.yaml
```
