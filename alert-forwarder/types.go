...
const (
	// TrapTypeUnknown represents an unknown trap type
	TrapTypeUnknown TrapType = "unknown"
	// TrapTypeFilesystemHoneytoken represents a filesystem honeytoken trap
	TrapTypeFilesystemHoneytoken TrapType = "filesystem_honeytoken"
	// TrapTypeHTTPEndpoint represents an HTTP endpoint trap
	TrapTypeHTTPEndpoint TrapType = "http_endpoint"
	// TrapTypeHTTPPayload represents an HTTP payload trap
